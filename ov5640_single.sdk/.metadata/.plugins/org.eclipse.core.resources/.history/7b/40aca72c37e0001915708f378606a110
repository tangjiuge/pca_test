...
*/
		while(1)
		 ...
		 // tyb_display((u32)shuzi4, tyb_pFrames[0],4 ,28 , 10, 300);
			//tyb_display((u32)tar_small_pic, tyb_pFrames[0],4 ,28 , 10, 300);
			/*printf("\r\n");
			printf("\r\n");
			printf("\r\n");
			for (i=0;i<28;i++)
			{
				...
				/*for(i=0;i<6;i++)
					{Xil_DCacheFlush();
					tyb_display((u32)(conv1_result+13*13*i), tyb_pFrames[0],6 ,13 , 200, 50+100*i);}
				for(i=0;i<6;i++)
					{Xil_DCacheFlush();
					tyb_display((u32)(conv2_result+11*11*i), tyb_pFrames[0],6 ,11 ,  300, 50+100*i);}
				for(i=0;i<6;i++)
					{Xil_DCacheFlush();
					tyb_display((u32)(conv3_result+9*9*i), tyb_pFrames[0],6 ,9 , 400, 50+100*i);}
				for(i=0;i<3;i++)
					{Xil_DCacheFlush();
					tyb_display((u32)(conv4_result+7*7*i), tyb_pFrames[0],6 ,7 , 500, 50+100*i);}
*/
