...
HD_PWD='D:/xilinx_projects/16_ov5640_single/ov5640_single.runs/system_auto_us_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_auto_us_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_auto_us_4.tcl
