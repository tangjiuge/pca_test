...
entity conv4_AXILiteS_s_axi is
generic (
...
end entity conv4_AXILiteS_s_axi;
...
architecture behave of conv4_AXILiteS_s_axi is
    ...
    constant ADDR_FEATURE_SRC_6_DATA_0  : INTEGER := 16#048#;
    constant ADDR_FEATURE_SRC_6_CTRL    : INTEGER := 16#04c#;
    constant ADDR_FEATURE_SRC_7_DATA_0  : INTEGER := 16#050#;
    constant ADDR_FEATURE_SRC_7_CTRL    : INTEGER := 16#054#;
    constant ADDR_WEIGHT_SRC_0_0_DATA_0 : INTEGER := 16#058#;
    constant ADDR_WEIGHT_SRC_0_0_CTRL   : INTEGER := 16#05c#;
    constant ADDR_WEIGHT_SRC_0_1_DATA_0 : INTEGER := 16#060#;
    constant ADDR_WEIGHT_SRC_0_1_CTRL   : INTEGER := 16#064#;
    constant ADDR_WEIGHT_SRC_0_2_DATA_0 : INTEGER := 16#068#;
    constant ADDR_WEIGHT_SRC_0_2_CTRL   : INTEGER := 16#06c#;
    constant ADDR_WEIGHT_SRC_0_3_DATA_0 : INTEGER := 16#070#;
    constant ADDR_WEIGHT_SRC_0_3_CTRL   : INTEGER := 16#074#;
    constant ADDR_WEIGHT_SRC_0_4_DATA_0 : INTEGER := 16#078#;
    constant ADDR_WEIGHT_SRC_0_4_CTRL   : INTEGER := 16#07c#;
    constant ADDR_WEIGHT_SRC_0_5_DATA_0 : INTEGER := 16#080#;
    constant ADDR_WEIGHT_SRC_0_5_CTRL   : INTEGER := 16#084#;
    constant ADDR_WEIGHT_SRC_0_6_DATA_0 : INTEGER := 16#088#;
    constant ADDR_WEIGHT_SRC_0_6_CTRL   : INTEGER := 16#08c#;
    constant ADDR_WEIGHT_SRC_0_7_DATA_0 : INTEGER := 16#090#;
    constant ADDR_WEIGHT_SRC_0_7_CTRL   : INTEGER := 16#094#;
    constant ADDR_WEIGHT_SRC_1_0_DATA_0 : INTEGER := 16#098#;
    constant ADDR_WEIGHT_SRC_1_0_CTRL   : INTEGER := 16#09c#;
    constant ADDR_WEIGHT_SRC_1_1_DATA_0 : INTEGER := 16#0a0#;
    constant ADDR_WEIGHT_SRC_1_1_CTRL   : INTEGER := 16#0a4#;
    constant ADDR_WEIGHT_SRC_1_2_DATA_0 : INTEGER := 16#0a8#;
    constant ADDR_WEIGHT_SRC_1_2_CTRL   : INTEGER := 16#0ac#;
    constant ADDR_WEIGHT_SRC_1_3_DATA_0 : INTEGER := 16#0b0#;
    constant ADDR_WEIGHT_SRC_1_3_CTRL   : INTEGER := 16#0b4#;
    constant ADDR_WEIGHT_SRC_1_4_DATA_0 : INTEGER := 16#0b8#;
    constant ADDR_WEIGHT_SRC_1_4_CTRL   : INTEGER := 16#0bc#;
    constant ADDR_WEIGHT_SRC_1_5_DATA_0 : INTEGER := 16#0c0#;
    constant ADDR_WEIGHT_SRC_1_5_CTRL   : INTEGER := 16#0c4#;
    constant ADDR_WEIGHT_SRC_1_6_DATA_0 : INTEGER := 16#0c8#;
    constant ADDR_WEIGHT_SRC_1_6_CTRL   : INTEGER := 16#0cc#;
    constant ADDR_WEIGHT_SRC_1_7_DATA_0 : INTEGER := 16#0d0#;
    constant ADDR_WEIGHT_SRC_1_7_CTRL   : INTEGER := 16#0d4#;
    constant ADDR_WEIGHT_SRC_2_0_DATA_0 : INTEGER := 16#0d8#;
    constant ADDR_WEIGHT_SRC_2_0_CTRL   : INTEGER := 16#0dc#;
    constant ADDR_WEIGHT_SRC_2_1_DATA_0 : INTEGER := 16#0e0#;
    constant ADDR_WEIGHT_SRC_2_1_CTRL   : INTEGER := 16#0e4#;
    constant ADDR_WEIGHT_SRC_2_2_DATA_0 : INTEGER := 16#0e8#;
    constant ADDR_WEIGHT_SRC_2_2_CTRL   : INTEGER := 16#0ec#;
    constant ADDR_WEIGHT_SRC_2_3_DATA_0 : INTEGER := 16#0f0#;
    constant ADDR_WEIGHT_SRC_2_3_CTRL   : INTEGER := 16#0f4#;
    constant ADDR_WEIGHT_SRC_2_4_DATA_0 : INTEGER := 16#0f8#;
    constant ADDR_WEIGHT_SRC_2_4_CTRL   : INTEGER := 16#0fc#;
    constant ADDR_WEIGHT_SRC_2_5_DATA_0 : INTEGER := 16#100#;
    constant ADDR_WEIGHT_SRC_2_5_CTRL   : INTEGER := 16#104#;
    constant ADDR_WEIGHT_SRC_2_6_DATA_0 : INTEGER := 16#108#;
    constant ADDR_WEIGHT_SRC_2_6_CTRL   : INTEGER := 16#10c#;
    constant ADDR_WEIGHT_SRC_2_7_DATA_0 : INTEGER := 16#110#;
    constant ADDR_WEIGHT_SRC_2_7_CTRL   : INTEGER := 16#114#;
    constant ADDR_WEIGHT_SRC_3_0_DATA_0 : INTEGER := 16#118#;
    constant ADDR_WEIGHT_SRC_3_0_CTRL   : INTEGER := 16#11c#;
    constant ADDR_WEIGHT_SRC_3_1_DATA_0 : INTEGER := 16#120#;
    constant ADDR_WEIGHT_SRC_3_1_CTRL   : INTEGER := 16#124#;
    constant ADDR_WEIGHT_SRC_3_2_DATA_0 : INTEGER := 16#128#;
    constant ADDR_WEIGHT_SRC_3_2_CTRL   : INTEGER := 16#12c#;
    constant ADDR_WEIGHT_SRC_3_3_DATA_0 : INTEGER := 16#130#;
    constant ADDR_WEIGHT_SRC_3_3_CTRL   : INTEGER := 16#134#;
    constant ADDR_WEIGHT_SRC_3_4_DATA_0 : INTEGER := 16#138#;
    constant ADDR_WEIGHT_SRC_3_4_CTRL   : INTEGER := 16#13c#;
    constant ADDR_WEIGHT_SRC_3_5_DATA_0 : INTEGER := 16#140#;
    constant ADDR_WEIGHT_SRC_3_5_CTRL   : INTEGER := 16#144#;
    constant ADDR_WEIGHT_SRC_3_6_DATA_0 : INTEGER := 16#148#;
    constant ADDR_WEIGHT_SRC_3_6_CTRL   : INTEGER := 16#14c#;
    constant ADDR_WEIGHT_SRC_3_7_DATA_0 : INTEGER := 16#150#;
    constant ADDR_WEIGHT_SRC_3_7_CTRL   : INTEGER := 16#154#;
    constant ADDR_WEIGHT_SRC_4_0_DATA_0 : INTEGER := 16#158#;
    constant ADDR_WEIGHT_SRC_4_0_CTRL   : INTEGER := 16#15c#;
    constant ADDR_WEIGHT_SRC_4_1_DATA_0 : INTEGER := 16#160#;
    constant ADDR_WEIGHT_SRC_4_1_CTRL   : INTEGER := 16#164#;
    constant ADDR_WEIGHT_SRC_4_2_DATA_0 : INTEGER := 16#168#;
    constant ADDR_WEIGHT_SRC_4_2_CTRL   : INTEGER := 16#16c#;
    constant ADDR_WEIGHT_SRC_4_3_DATA_0 : INTEGER := 16#170#;
    constant ADDR_WEIGHT_SRC_4_3_CTRL   : INTEGER := 16#174#;
    constant ADDR_WEIGHT_SRC_4_4_DATA_0 : INTEGER := 16#178#;
    constant ADDR_WEIGHT_SRC_4_4_CTRL   : INTEGER := 16#17c#;
    constant ADDR_WEIGHT_SRC_4_5_DATA_0 : INTEGER := 16#180#;
    constant ADDR_WEIGHT_SRC_4_5_CTRL   : INTEGER := 16#184#;
    constant ADDR_WEIGHT_SRC_4_6_DATA_0 : INTEGER := 16#188#;
    constant ADDR_WEIGHT_SRC_4_6_CTRL   : INTEGER := 16#18c#;
    constant ADDR_WEIGHT_SRC_4_7_DATA_0 : INTEGER := 16#190#;
    constant ADDR_WEIGHT_SRC_4_7_CTRL   : INTEGER := 16#194#;
    constant ADDR_WEIGHT_SRC_5_0_DATA_0 : INTEGER := 16#198#;
    constant ADDR_WEIGHT_SRC_5_0_CTRL   : INTEGER := 16#19c#;
    constant ADDR_WEIGHT_SRC_5_1_DATA_0 : INTEGER := 16#1a0#;
    constant ADDR_WEIGHT_SRC_5_1_CTRL   : INTEGER := 16#1a4#;
    constant ADDR_WEIGHT_SRC_5_2_DATA_0 : INTEGER := 16#1a8#;
    constant ADDR_WEIGHT_SRC_5_2_CTRL   : INTEGER := 16#1ac#;
    constant ADDR_WEIGHT_SRC_5_3_DATA_0 : INTEGER := 16#1b0#;
    constant ADDR_WEIGHT_SRC_5_3_CTRL   : INTEGER := 16#1b4#;
    constant ADDR_WEIGHT_SRC_5_4_DATA_0 : INTEGER := 16#1b8#;
    constant ADDR_WEIGHT_SRC_5_4_CTRL   : INTEGER := 16#1bc#;
    constant ADDR_WEIGHT_SRC_5_5_DATA_0 : INTEGER := 16#1c0#;
    constant ADDR_WEIGHT_SRC_5_5_CTRL   : INTEGER := 16#1c4#;
    constant ADDR_WEIGHT_SRC_5_6_DATA_0 : INTEGER := 16#1c8#;
    constant ADDR_WEIGHT_SRC_5_6_CTRL   : INTEGER := 16#1cc#;
    constant ADDR_WEIGHT_SRC_5_7_DATA_0 : INTEGER := 16#1d0#;
    constant ADDR_WEIGHT_SRC_5_7_CTRL   : INTEGER := 16#1d4#;
    constant ADDR_WEIGHT_SRC_6_0_DATA_0 : INTEGER := 16#1d8#;
    constant ADDR_WEIGHT_SRC_6_0_CTRL   : INTEGER := 16#1dc#;
    constant ADDR_WEIGHT_SRC_6_1_DATA_0 : INTEGER := 16#1e0#;
    constant ADDR_WEIGHT_SRC_6_1_CTRL   : INTEGER := 16#1e4#;
    constant ADDR_WEIGHT_SRC_6_2_DATA_0 : INTEGER := 16#1e8#;
    constant ADDR_WEIGHT_SRC_6_2_CTRL   : INTEGER := 16#1ec#;
    constant ADDR_WEIGHT_SRC_6_3_DATA_0 : INTEGER := 16#1f0#;
    constant ADDR_WEIGHT_SRC_6_3_CTRL   : INTEGER := 16#1f4#;
    constant ADDR_WEIGHT_SRC_6_4_DATA_0 : INTEGER := 16#1f8#;
    constant ADDR_WEIGHT_SRC_6_4_CTRL   : INTEGER := 16#1fc#;
    constant ADDR_WEIGHT_SRC_6_5_DATA_0 : INTEGER := 16#200#;
    constant ADDR_WEIGHT_SRC_6_5_CTRL   : INTEGER := 16#204#;
    constant ADDR_WEIGHT_SRC_6_6_DATA_0 : INTEGER := 16#208#;
    constant ADDR_WEIGHT_SRC_6_6_CTRL   : INTEGER := 16#20c#;
    constant ADDR_WEIGHT_SRC_6_7_DATA_0 : INTEGER := 16#210#;
    constant ADDR_WEIGHT_SRC_6_7_CTRL   : INTEGER := 16#214#;
    constant ADDR_WEIGHT_SRC_7_0_DATA_0 : INTEGER := 16#218#;
    constant ADDR_WEIGHT_SRC_7_0_CTRL   : INTEGER := 16#21c#;
    constant ADDR_WEIGHT_SRC_7_1_DATA_0 : INTEGER := 16#220#;
    constant ADDR_WEIGHT_SRC_7_1_CTRL   : INTEGER := 16#224#;
    constant ADDR_WEIGHT_SRC_7_2_DATA_0 : INTEGER := 16#228#;
    constant ADDR_WEIGHT_SRC_7_2_CTRL   : INTEGER := 16#22c#;
    constant ADDR_WEIGHT_SRC_7_3_DATA_0 : INTEGER := 16#230#;
    constant ADDR_WEIGHT_SRC_7_3_CTRL   : INTEGER := 16#234#;
    constant ADDR_WEIGHT_SRC_7_4_DATA_0 : INTEGER := 16#238#;
    constant ADDR_WEIGHT_SRC_7_4_CTRL   : INTEGER := 16#23c#;
    constant ADDR_WEIGHT_SRC_7_5_DATA_0 : INTEGER := 16#240#;
    constant ADDR_WEIGHT_SRC_7_5_CTRL   : INTEGER := 16#244#;
    constant ADDR_WEIGHT_SRC_7_6_DATA_0 : INTEGER := 16#248#;
    constant ADDR_WEIGHT_SRC_7_6_CTRL   : INTEGER := 16#24c#;
    constant ADDR_WEIGHT_SRC_7_7_DATA_0 : INTEGER := 16#250#;
    constant ADDR_WEIGHT_SRC_7_7_CTRL   : INTEGER := 16#254#;
    constant ADDR_WEIGHT_SRC_8_0_DATA_0 : INTEGER := 16#258#;
    constant ADDR_WEIGHT_SRC_8_0_CTRL   : INTEGER := 16#25c#;
    constant ADDR_WEIGHT_SRC_8_1_DATA_0 : INTEGER := 16#260#;
    constant ADDR_WEIGHT_SRC_8_1_CTRL   : INTEGER := 16#264#;
    constant ADDR_WEIGHT_SRC_8_2_DATA_0 : INTEGER := 16#268#;
    constant ADDR_WEIGHT_SRC_8_2_CTRL   : INTEGER := 16#26c#;
    constant ADDR_WEIGHT_SRC_8_3_DATA_0 : INTEGER := 16#270#;
    constant ADDR_WEIGHT_SRC_8_3_CTRL   : INTEGER := 16#274#;
    constant ADDR_WEIGHT_SRC_8_4_DATA_0 : INTEGER := 16#278#;
    constant ADDR_WEIGHT_SRC_8_4_CTRL   : INTEGER := 16#27c#;
    constant ADDR_WEIGHT_SRC_8_5_DATA_0 : INTEGER := 16#280#;
    constant ADDR_WEIGHT_SRC_8_5_CTRL   : INTEGER := 16#284#;
    constant ADDR_WEIGHT_SRC_8_6_DATA_0 : INTEGER := 16#288#;
    constant ADDR_WEIGHT_SRC_8_6_CTRL   : INTEGER := 16#28c#;
    constant ADDR_WEIGHT_SRC_8_7_DATA_0 : INTEGER := 16#290#;
    constant ADDR_WEIGHT_SRC_8_7_CTRL   : INTEGER := 16#294#;
    constant ADDR_WEIGHT_SRC_9_0_DATA_0 : INTEGER := 16#298#;
    constant ADDR_WEIGHT_SRC_9_0_CTRL   : INTEGER := 16#29c#;
    constant ADDR_WEIGHT_SRC_9_1_DATA_0 : INTEGER := 16#2a0#;
    constant ADDR_WEIGHT_SRC_9_1_CTRL   : INTEGER := 16#2a4#;
    constant ADDR_WEIGHT_SRC_9_2_DATA_0 : INTEGER := 16#2a8#;
    constant ADDR_WEIGHT_SRC_9_2_CTRL   : INTEGER := 16#2ac#;
    constant ADDR_WEIGHT_SRC_9_3_DATA_0 : INTEGER := 16#2b0#;
    constant ADDR_WEIGHT_SRC_9_3_CTRL   : INTEGER := 16#2b4#;
    constant ADDR_WEIGHT_SRC_9_4_DATA_0 : INTEGER := 16#2b8#;
    constant ADDR_WEIGHT_SRC_9_4_CTRL   : INTEGER := 16#2bc#;
    constant ADDR_WEIGHT_SRC_9_5_DATA_0 : INTEGER := 16#2c0#;
    constant ADDR_WEIGHT_SRC_9_5_CTRL   : INTEGER := 16#2c4#;
    constant ADDR_WEIGHT_SRC_9_6_DATA_0 : INTEGER := 16#2c8#;
    constant ADDR_WEIGHT_SRC_9_6_CTRL   : INTEGER := 16#2cc#;
    constant ADDR_WEIGHT_SRC_9_7_DATA_0 : INTEGER := 16#2d0#;
    constant ADDR_WEIGHT_SRC_9_7_CTRL   : INTEGER := 16#2d4#;
    constant ADDR_BIAS_DATA_0           : INTEGER := 16#2d8#;
    constant ADDR_BIAS_CTRL             : INTEGER := 16#2dc#;
    constant ADDR_FEATURE_DST_0_DATA_0  : INTEGER := 16#2e0#;
    constant ADDR_FEATURE_DST_0_CTRL    : INTEGER := 16#2e4#;
    constant ADDR_FEATURE_DST_1_DATA_0  : INTEGER := 16#2e8#;
    constant ADDR_FEATURE_DST_1_CTRL    : INTEGER := 16#2ec#;
    constant ADDR_FEATURE_DST_2_DATA_0  : INTEGER := 16#2f0#;
    constant ADDR_FEATURE_DST_2_CTRL    : INTEGER := 16#2f4#;
    constant ADDR_FEATURE_DST_3_DATA_0  : INTEGER := 16#2f8#;
    constant ADDR_FEATURE_DST_3_CTRL    : INTEGER := 16#2fc#;
    constant ADDR_FEATURE_DST_4_DATA_0  : INTEGER := 16#300#;
    constant ADDR_FEATURE_DST_4_CTRL    : INTEGER := 16#304#;
    constant ADDR_FEATURE_DST_5_DATA_0  : INTEGER := 16#308#;
    constant ADDR_FEATURE_DST_5_CTRL    : INTEGER := 16#30c#;
    constant ADDR_FEATURE_DST_6_DATA_0  : INTEGER := 16#310#;
    constant ADDR_FEATURE_DST_6_CTRL    : INTEGER := 16#314#;
    constant ADDR_FEATURE_DST_7_DATA_0  : INTEGER := 16#318#;
    constant ADDR_FEATURE_DST_7_CTRL    : INTEGER := 16#31c#;
    constant ADDR_FEATURE_DST_8_DATA_0  : INTEGER := 16#320#;
    constant ADDR_FEATURE_DST_8_CTRL    : INTEGER := 16#324#;
    constant ADDR_FEATURE_DST_9_DATA_0  : INTEGER := 16#328#;
    constant ADDR_FEATURE_DST_9_CTRL    : INTEGER := 16#32c#;
    ...
    signal int_feature_src_6   : UNSIGNED(31 downto 0) := (others => '0');
    signal int_feature_src_7   : UNSIGNED(31 downto 0) := (others => '0');
    ...
    signal int_weight_src_0_6  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_0_7  : UNSIGNED(31 downto 0) := (others => '0');
    ...
    signal int_weight_src_1_6  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_1_7  : UNSIGNED(31 downto 0) := (others => '0');
    ...
    signal int_weight_src_2_6  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_2_7  : UNSIGNED(31 downto 0) := (others => '0');
    ...
    signal int_weight_src_3_6  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_3_7  : UNSIGNED(31 downto 0) := (others => '0');
    ...
    signal int_weight_src_4_6  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_4_7  : UNSIGNED(31 downto 0) := (others => '0');
    ...
    signal int_weight_src_5_6  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_5_7  : UNSIGNED(31 downto 0) := (others => '0');
    ...
    signal int_weight_src_6_6  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_6_7  : UNSIGNED(31 downto 0) := (others => '0');
    ...
    signal int_weight_src_7_6  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_7_7  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_8_0  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_8_1  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_8_2  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_8_3  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_8_4  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_8_5  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_8_6  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_8_7  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_9_0  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_9_1  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_9_2  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_9_3  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_9_4  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_9_5  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_9_6  : UNSIGNED(31 downto 0) := (others => '0');
    signal int_weight_src_9_7  : UNSIGNED(31 downto 0) := (others => '0');
    ...
    signal int_feature_dst_8   : UNSIGNED(31 downto 0) := (others => '0');
    signal int_feature_dst_9   : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_FEATURE_SRC_6_DATA_0 =>
                        rdata_data <= RESIZE(int_feature_src_6(31 downto 0), 32);
                    when ADDR_FEATURE_SRC_7_DATA_0 =>
                        rdata_data <= RESIZE(int_feature_src_7(31 downto 0), 32);
                    ...
                    when ADDR_WEIGHT_SRC_0_6_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_0_6(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_0_7_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_0_7(31 downto 0), 32);
                    ...
                    when ADDR_WEIGHT_SRC_1_6_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_1_6(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_1_7_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_1_7(31 downto 0), 32);
                    ...
                    when ADDR_WEIGHT_SRC_2_6_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_2_6(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_2_7_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_2_7(31 downto 0), 32);
                    ...
                    when ADDR_WEIGHT_SRC_3_6_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_3_6(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_3_7_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_3_7(31 downto 0), 32);
                    ...
                    when ADDR_WEIGHT_SRC_4_6_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_4_6(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_4_7_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_4_7(31 downto 0), 32);
                    ...
                    when ADDR_WEIGHT_SRC_5_6_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_5_6(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_5_7_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_5_7(31 downto 0), 32);
                    ...
                    when ADDR_WEIGHT_SRC_6_6_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_6_6(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_6_7_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_6_7(31 downto 0), 32);
                    ...
                    when ADDR_WEIGHT_SRC_7_6_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_7_6(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_7_7_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_7_7(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_8_0_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_8_0(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_8_1_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_8_1(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_8_2_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_8_2(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_8_3_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_8_3(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_8_4_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_8_4(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_8_5_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_8_5(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_8_6_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_8_6(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_8_7_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_8_7(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_9_0_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_9_0(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_9_1_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_9_1(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_9_2_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_9_2(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_9_3_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_9_3(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_9_4_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_9_4(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_9_5_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_9_5(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_9_6_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_9_6(31 downto 0), 32);
                    when ADDR_WEIGHT_SRC_9_7_DATA_0 =>
                        rdata_data <= RESIZE(int_weight_src_9_7(31 downto 0), 32);
                    ...
                    when ADDR_FEATURE_DST_8_DATA_0 =>
                        rdata_data <= RESIZE(int_feature_dst_8(31 downto 0), 32);
                    when ADDR_FEATURE_DST_9_DATA_0 =>
                        rdata_data <= RESIZE(int_feature_dst_9(31 downto 0), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    feature_src_6        <= STD_LOGIC_VECTOR(int_feature_src_6);
    feature_src_7        <= STD_LOGIC_VECTOR(int_feature_src_7);
    ...
    weight_src_0_6       <= STD_LOGIC_VECTOR(int_weight_src_0_6);
    weight_src_0_7       <= STD_LOGIC_VECTOR(int_weight_src_0_7);
    ...
    weight_src_1_6       <= STD_LOGIC_VECTOR(int_weight_src_1_6);
    weight_src_1_7       <= STD_LOGIC_VECTOR(int_weight_src_1_7);
    ...
    weight_src_2_6       <= STD_LOGIC_VECTOR(int_weight_src_2_6);
    weight_src_2_7       <= STD_LOGIC_VECTOR(int_weight_src_2_7);
    ...
    weight_src_3_6       <= STD_LOGIC_VECTOR(int_weight_src_3_6);
    weight_src_3_7       <= STD_LOGIC_VECTOR(int_weight_src_3_7);
    ...
    weight_src_4_6       <= STD_LOGIC_VECTOR(int_weight_src_4_6);
    weight_src_4_7       <= STD_LOGIC_VECTOR(int_weight_src_4_7);
    ...
    weight_src_5_6       <= STD_LOGIC_VECTOR(int_weight_src_5_6);
    weight_src_5_7       <= STD_LOGIC_VECTOR(int_weight_src_5_7);
    ...
    weight_src_6_6       <= STD_LOGIC_VECTOR(int_weight_src_6_6);
    weight_src_6_7       <= STD_LOGIC_VECTOR(int_weight_src_6_7);
    ...
    weight_src_7_6       <= STD_LOGIC_VECTOR(int_weight_src_7_6);
    weight_src_7_7       <= STD_LOGIC_VECTOR(int_weight_src_7_7);
    weight_src_8_0       <= STD_LOGIC_VECTOR(int_weight_src_8_0);
    weight_src_8_1       <= STD_LOGIC_VECTOR(int_weight_src_8_1);
    weight_src_8_2       <= STD_LOGIC_VECTOR(int_weight_src_8_2);
    weight_src_8_3       <= STD_LOGIC_VECTOR(int_weight_src_8_3);
    weight_src_8_4       <= STD_LOGIC_VECTOR(int_weight_src_8_4);
    weight_src_8_5       <= STD_LOGIC_VECTOR(int_weight_src_8_5);
    weight_src_8_6       <= STD_LOGIC_VECTOR(int_weight_src_8_6);
    weight_src_8_7       <= STD_LOGIC_VECTOR(int_weight_src_8_7);
    weight_src_9_0       <= STD_LOGIC_VECTOR(int_weight_src_9_0);
    weight_src_9_1       <= STD_LOGIC_VECTOR(int_weight_src_9_1);
    weight_src_9_2       <= STD_LOGIC_VECTOR(int_weight_src_9_2);
    weight_src_9_3       <= STD_LOGIC_VECTOR(int_weight_src_9_3);
    weight_src_9_4       <= STD_LOGIC_VECTOR(int_weight_src_9_4);
    weight_src_9_5       <= STD_LOGIC_VECTOR(int_weight_src_9_5);
    weight_src_9_6       <= STD_LOGIC_VECTOR(int_weight_src_9_6);
    weight_src_9_7       <= STD_LOGIC_VECTOR(int_weight_src_9_7);
    ...
    feature_dst_8        <= STD_LOGIC_VECTOR(int_feature_dst_8);
    feature_dst_9        <= STD_LOGIC_VECTOR(int_feature_dst_9);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_FEATURE_SRC_6_DATA_0) then
                    int_feature_src_6(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_feature_src_6(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_FEATURE_SRC_7_DATA_0) then
                    int_feature_src_7(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_feature_src_7(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_0_6_DATA_0) then
                    int_weight_src_0_6(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_0_6(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_0_7_DATA_0) then
                    int_weight_src_0_7(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_0_7(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_1_6_DATA_0) then
                    int_weight_src_1_6(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_1_6(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_1_7_DATA_0) then
                    int_weight_src_1_7(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_1_7(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_2_6_DATA_0) then
                    int_weight_src_2_6(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_2_6(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_2_7_DATA_0) then
                    int_weight_src_2_7(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_2_7(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_3_6_DATA_0) then
                    int_weight_src_3_6(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_3_6(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_3_7_DATA_0) then
                    int_weight_src_3_7(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_3_7(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_4_6_DATA_0) then
                    int_weight_src_4_6(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_4_6(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_4_7_DATA_0) then
                    int_weight_src_4_7(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_4_7(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_5_6_DATA_0) then
                    int_weight_src_5_6(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_5_6(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_5_7_DATA_0) then
                    int_weight_src_5_7(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_5_7(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_6_6_DATA_0) then
                    int_weight_src_6_6(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_6_6(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_6_7_DATA_0) then
                    int_weight_src_6_7(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_6_7(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_7_6_DATA_0) then
                    int_weight_src_7_6(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_7_6(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_7_7_DATA_0) then
                    int_weight_src_7_7(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_7_7(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_8_0_DATA_0) then
                    int_weight_src_8_0(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_8_0(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_8_1_DATA_0) then
                    int_weight_src_8_1(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_8_1(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_8_2_DATA_0) then
                    int_weight_src_8_2(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_8_2(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_8_3_DATA_0) then
                    int_weight_src_8_3(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_8_3(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_8_4_DATA_0) then
                    int_weight_src_8_4(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_8_4(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_8_5_DATA_0) then
                    int_weight_src_8_5(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_8_5(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_8_6_DATA_0) then
                    int_weight_src_8_6(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_8_6(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_8_7_DATA_0) then
                    int_weight_src_8_7(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_8_7(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_9_0_DATA_0) then
                    int_weight_src_9_0(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_9_0(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_9_1_DATA_0) then
                    int_weight_src_9_1(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_9_1(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_9_2_DATA_0) then
                    int_weight_src_9_2(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_9_2(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_9_3_DATA_0) then
                    int_weight_src_9_3(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_9_3(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_9_4_DATA_0) then
                    int_weight_src_9_4(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_9_4(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_9_5_DATA_0) then
                    int_weight_src_9_5(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_9_5(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_9_6_DATA_0) then
                    int_weight_src_9_6(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_9_6(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_WEIGHT_SRC_9_7_DATA_0) then
                    int_weight_src_9_7(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_weight_src_9_7(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_FEATURE_DST_8_DATA_0) then
                    int_feature_dst_8(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_feature_dst_8(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_FEATURE_DST_9_DATA_0) then
                    int_feature_dst_9(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_feature_dst_9(31 downto 0));
                end if;
            end if;
        end if;
    end process;
