...
entity conv2_AXILiteS_s_axi is
generic (
...
end entity conv2_AXILiteS_s_axi;
...
architecture behave of conv2_AXILiteS_s_axi is
    ...
    constant ADDR_BIAS_DATA_0           : INTEGER := 16#168#;
    constant ADDR_BIAS_CTRL             : INTEGER := 16#16c#;
    constant ADDR_FEATURE_DST_0_DATA_0  : INTEGER := 16#170#;
    constant ADDR_FEATURE_DST_0_CTRL    : INTEGER := 16#174#;
    constant ADDR_FEATURE_DST_1_DATA_0  : INTEGER := 16#178#;
    constant ADDR_FEATURE_DST_1_CTRL    : INTEGER := 16#17c#;
    constant ADDR_FEATURE_DST_2_DATA_0  : INTEGER := 16#180#;
    constant ADDR_FEATURE_DST_2_CTRL    : INTEGER := 16#184#;
    constant ADDR_FEATURE_DST_3_DATA_0  : INTEGER := 16#188#;
    constant ADDR_FEATURE_DST_3_CTRL    : INTEGER := 16#18c#;
    constant ADDR_FEATURE_DST_4_DATA_0  : INTEGER := 16#190#;
    constant ADDR_FEATURE_DST_4_CTRL    : INTEGER := 16#194#;
    constant ADDR_FEATURE_DST_5_DATA_0  : INTEGER := 16#198#;
    constant ADDR_FEATURE_DST_5_CTRL    : INTEGER := 16#19c#;
