...
entity conv1_AXILiteS_s_axi is
generic (
...
end entity conv1_AXILiteS_s_axi;
...
architecture behave of conv1_AXILiteS_s_axi is
    ...
    constant ADDR_FEATURE_SRC_0_DATA_0  : INTEGER := 16#18#;
    constant ADDR_FEATURE_SRC_0_CTRL    : INTEGER := 16#1c#;
    constant ADDR_WEIGHT_SRC_0_0_DATA_0 : INTEGER := 16#20#;
    constant ADDR_WEIGHT_SRC_0_0_CTRL   : INTEGER := 16#24#;
    constant ADDR_WEIGHT_SRC_1_0_DATA_0 : INTEGER := 16#28#;
    constant ADDR_WEIGHT_SRC_1_0_CTRL   : INTEGER := 16#2c#;
    constant ADDR_WEIGHT_SRC_2_0_DATA_0 : INTEGER := 16#30#;
    constant ADDR_WEIGHT_SRC_2_0_CTRL   : INTEGER := 16#34#;
    constant ADDR_WEIGHT_SRC_3_0_DATA_0 : INTEGER := 16#38#;
    constant ADDR_WEIGHT_SRC_3_0_CTRL   : INTEGER := 16#3c#;
    constant ADDR_WEIGHT_SRC_4_0_DATA_0 : INTEGER := 16#40#;
    constant ADDR_WEIGHT_SRC_4_0_CTRL   : INTEGER := 16#44#;
    constant ADDR_WEIGHT_SRC_5_0_DATA_0 : INTEGER := 16#48#;
    constant ADDR_WEIGHT_SRC_5_0_CTRL   : INTEGER := 16#4c#;
    constant ADDR_BIAS_DATA_0           : INTEGER := 16#50#;
    constant ADDR_BIAS_CTRL             : INTEGER := 16#54#;
    constant ADDR_FEATURE_DST_0_DATA_0  : INTEGER := 16#58#;
    constant ADDR_FEATURE_DST_0_CTRL    : INTEGER := 16#5c#;
    constant ADDR_FEATURE_DST_1_DATA_0  : INTEGER := 16#60#;
    constant ADDR_FEATURE_DST_1_CTRL    : INTEGER := 16#64#;
    constant ADDR_FEATURE_DST_2_DATA_0  : INTEGER := 16#68#;
    constant ADDR_FEATURE_DST_2_CTRL    : INTEGER := 16#6c#;
    constant ADDR_FEATURE_DST_3_DATA_0  : INTEGER := 16#70#;
    constant ADDR_FEATURE_DST_3_CTRL    : INTEGER := 16#74#;
    constant ADDR_FEATURE_DST_4_DATA_0  : INTEGER := 16#78#;
    constant ADDR_FEATURE_DST_4_CTRL    : INTEGER := 16#7c#;
    constant ADDR_FEATURE_DST_5_DATA_0  : INTEGER := 16#80#;
    constant ADDR_FEATURE_DST_5_CTRL    : INTEGER := 16#84#;
