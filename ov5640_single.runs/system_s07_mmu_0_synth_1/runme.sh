...
HD_PWD='D:/xilinx_projects/pca_test/ov5640_single.runs/system_s07_mmu_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_s07_mmu_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_s07_mmu_0.tcl
