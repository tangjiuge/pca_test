...
HD_PWD='D:/xilinx_projects/16_ov5640_single/ov5640_single.runs/system_hls_core_1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_hls_core_1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_hls_core_1_0_0.tcl
