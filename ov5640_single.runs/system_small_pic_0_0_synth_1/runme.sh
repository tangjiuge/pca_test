...
HD_PWD='D:/xilinx_projects/16_ov5640_single/ov5640_single.runs/system_small_pic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_small_pic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_small_pic_0_0.tcl
